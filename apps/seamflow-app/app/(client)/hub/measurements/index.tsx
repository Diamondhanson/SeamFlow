  ...
  return (
    <Screen padded={false}>
      <View style={styles.padded}>
        <ScreenHeader title={t('cmeasurements.title')} subtitle={t('cmeasurements.subtitle')} />
      </View>
          ...
          renderItem={({ item }) => {
            ...
            return (
              <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.hairline }]}>
                ...
                <Text variant="bodySm" tone="textMuted">{t('cmeasurements.savedBy', { name: item.tailorBusinessName })}</Text>
