// ============================================================================
// Messages — your conversations with tailors
// (ROADMAP D.4.3).
//
// Deliberately NOT the AI assistant. That is a copilot; this is a human on the
// other end. Different screens, different systems.
//
// Empty until you've asked a tailor about something — so the empty state
// points back at the feed rather than leaving a dead end.
// ============================================================================
  ...
  return (
    <Screen padded={false}>
      <View style={styles.padded}>
        <ScreenHeader title={t('cchat.listTitle')} />
        <Text variant="bodySm" tone="textMuted">
          {t('cchat.listSubtitle')}
        </Text>
      </View>
          ...
          {items.map((c) => {
            ...
            return (
              <Pressable
                key={c.id}
                onPress={() =>
                  router.push({ pathname: '/hub/messages/[id]', params: { id: c.id } })
                }
                style={[
                  styles.row,
