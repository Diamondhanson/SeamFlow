...
export default function Notifications() {
  ...
  const header = <ScreenHeader title={t('cnotifications.title')} />;
      ...
      <Screen>
        ...
        <View style={styles.empty}>
          ...
          <Text variant="bodySm" tone="textMuted" style={styles.emptyBody}>
            {t('cnotifications.loadFailed')}
          </Text>
          <Pressable onPress={() => void q.refetch()} hitSlop={8} style={{ marginTop: spacing.md }}>
            <Text variant="body" tone="primary">{t('ccommon.retry')}</Text>
          </Pressable>
        </View>
      </Screen>
    );
        ...
        <View style={styles.bar}>
          <Text variant="caption" tone="textMuted">
            {unread === 1
              ...
              : t('cnotifications.unreadMany', { count: unread })}
          </Text>
          <Pressable onPress={() => markAllRead.mutate()} hitSlop={8}>
            <Text variant="caption" tone="primary">
              {t('cnotifications.markAllRead')}
            </Text>
          </Pressable>
        </View>
      ) : null}
            ...
            >
              ...
              <View style={styles.body}>
                <Text variant="body">
                  ...
                  {t(`cnotifications.type_${n.type.replace(/\./g, '_')}`, n.params)}
                </Text>
