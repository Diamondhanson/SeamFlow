...
export const feed = {
  en: {
    ...
    occasionSection: 'When is it worn?',
    colorsSection: 'Colours',
    styleSection: 'Style',
    noneYet: 'Nothing chosen yet',
    whySection: 'Why this matters',
    whyBody: 'These are what shoppers search by. The more that is right, the more often this design is found.',
    // ── Publishing a photo ──────────────────────────────────────────────────
  ...
  fr: {
    ...
    occasionSection: 'Porté quand ?',
    colorsSection: 'Couleurs',
    styleSection: 'Style',
    noneYet: 'Rien de choisi',
    whySection: 'Pourquoi c’est important',
    whyBody: 'C’est ce que les clients recherchent. Plus c’est juste, plus ce modèle sera trouvé.',
  ...
  pt: {
    ...
    occasionSection: 'Quando se usa?',
    colorsSection: 'Cores',
    styleSection: 'Estilo',
    noneYet: 'Nada escolhido ainda',
    whySection: 'Porque isto importa',
    whyBody: 'É por aqui que os clientes procuram. Quanto mais certo estiver, mais vezes este modelo é encontrado.',
    // ── Publicar uma foto ───────────────────────────────────────────────────
  ...
  es: {
    ...
    changeGarment: 'Cambiar',
    audienceSection: '¿Para quién es?',
    occasionSection: '¿Cuándo se lleva?',
    colorsSection: 'Colores',
    styleSection: 'Estilo',
    noneYet: 'Nada elegido todavía',
    whySection: 'Por qué importa',
    whyBody: 'Es por lo que buscan los clientes. Cuanto más correcto, más se encontrará este diseño.',
    // ── Publicar una foto ───────────────────────────────────────────────────
  ...
  sw: {
    ...
    occasionSection: 'Huvaliwa lini?',
    colorsSection: 'Rangi',
    styleSection: 'Mtindo',
    noneYet: 'Hakuna kilichochaguliwa',
    whySection: 'Kwa nini hii ni muhimu',
    whyBody: 'Hivi ndivyo wanunuzi wanavyotafuta. Kadiri yanavyokuwa sahihi, ndivyo muundo huu utakavyopatikana zaidi.',
    // ── Kuchapisha picha ────────────────────────────────────────────────────
  ...
  ar: {
    ...
    occasionSection: 'متى يُلبس؟',
    colorsSection: 'الألوان',
    styleSection: 'الطراز',
    noneYet: 'لم يتم اختيار شيء بعد',
    whySection: 'لماذا هذا مهم',
    whyBody: 'هذا ما يبحث به المتسوقون. كلما زادت دقته، زادت فرص العثور على هذا التصميم.',
    publishAction: 'اعرضه في الواجهة',
    unpublishAction: 'إزالة من الواجهة',
    inFeedBadge: 'في الواجهة',
    publishTitle: 'اعرض هذا في الواجهة',
    publishBody:
      'تصبح هذه الصورة عامة: يمكن لأي متصفّح لـ SeamFlow أن يراها ويطلب منك شيئًا مشابهًا. لا يُعرض اسم عميلك ولا مقاساته ولا تفاصيل طلبه أبدًا.',
    captionLabel: 'الوصف',
    captionPlaceholder: 'مثال: أغبادا زفاف من بروكار كريمي',
    garmentTypeLabel: 'الثوب',
    garmentTypePlaceholder: 'مثال: أغبادا، فستان، بدلة',
    tagsLabel: 'الوسوم (مفصولة بفواصل)',
    tagsPlaceholder: 'أنكارا، زفاف، تطريز يدوي',
    fabricLabel: 'القماش',
    fabricPlaceholder: 'مثال: بروكار كريمي',
    startingPriceLabel: 'السعر الابتدائي (اختياري)',
    startingPriceHelp: 'يُعرض كسعر «ابتداءً من». اتركه فارغًا لعدم ذكر السعر.',
    publishCta: 'نشر',
    publishing: 'ينشر…',
    publishedTitle: 'نُشر',
    publishedBody: 'عملك الآن في الواجهة.',
    publishError: 'تعذّر نشر هذه الصورة',

    unpublishConfirmTitle: 'إزالة من الواجهة؟',
    unpublishConfirmBody:
      'ستختفي من الواجهة العامة فورًا. وتبقى الصورة على الطلب.',
    unpublishedTitle: 'أُزيلت من الواجهة',

    myWorkTitle: 'أعمالي المنشورة',
    myWorkSubtitle: 'كل ما عرضته في الواجهة العامة.',
    myWorkEmpty:
      'لا شيء منشور بعد. افتح طلبًا منجزًا، انقر صورة، واختر «اعرضه في الواجهة».',
    hiddenLabel: 'مخفي',
    ...
    cityLabel: 'المدينة',
    cityPlaceholder: 'مثال: دوالا',
    specialtiesLabel: 'التخصّصات',
    specialtiesPlaceholder: 'أزياء العرائس، أغبادا، خياطة رجالية',
    languagesLabel: 'اللغات التي تتحدّثها',
    languagesPlaceholder: 'العربية، الفرنسية',
    acceptsRemoteLabel: 'قبول طلبات من مدن أخرى',
    acceptsRemoteHelp:
    ...
    storefrontSaved: 'تم تحديث واجهة الورشة',

    worksTitle: 'ابتكاراتي',
    worksTileSubtitle: 'أعمال صنعتها',
    worksSubtitle:
    ...
    publishedFilter: 'منشورة',
    unpublishedFilter: 'غير منشورة',
    allFilter: 'الكل',
    filterGarment: 'الثوب',
    filterAudience: 'لمن هو',
    filterFabric: 'القماش',
    filterOccasion: 'المناسبة',
    clearFilters: 'مسح التصفية',
    noMatch: 'لا ابتكارات تطابق هذه التصفية.',
    editDesign: 'تعديل التصميم',
    deleteDesign: 'حذف التصميم',
    deleteConfirmTitle: 'حذف هذا التصميم؟',
    deleteConfirmBody:
      'سيُزال من معرض أعمالك، ومن الواجهة العامة إن كان منشورًا. لا يمكن التراجع عن هذا.',
    titleLabel: 'العنوان',
    titlePlaceholder: 'مثال: أغبادا بروكار كريمي',
    audienceLabel: 'لمن هو',
    occasionLabel: 'المناسبة',
    audience_women: 'نساء',
    audience_men: 'رجال',
    audience_unisex: 'للجنسين',
    audience_children: 'أطفال',
    occasion_wedding: 'زفاف',
    occasion_traditional: 'تقليدي',
    occasion_corporate: 'رسمي',
    occasion_casual: 'يومي',
    occasion_party: 'حفلة',
    saveDesign: 'حفظ',
    publishedToggle: 'منشور في الواجهة',
    ...
    linkCopiedBody: 'الصقه في أي مكان تريد أن يجد الناس عملك فيه.',
    couldNotShareCatalogue: 'تعذّرت مشاركة كتالوجك',
    ...
    catalogueAddressSaved: 'تم تحديث عنوان الكتالوج',
    ...
    describeSubtitle:
      'كل شيء اختياري. ما تضيفه هنا هو ما يراه العملاء في كتالوجك.',
    describeUploading: 'يرفع {done} من {total}…',
    describeUploadFailed: 'تعذّر رفع صورك',
    descriptionLabel: 'الوصف',
    descriptionPlaceholder: 'مثال: فتحة رقبة مطرّزة يدويًا، صدر مبطّن. يُخاط على المقاس في أسبوعين.',
    priceLabel: 'السعر الابتدائي',
    pricePlaceholder: 'مثال: 45000',
    priceHelp:
      'يُعرض للعملاء كـ«ابتداءً من {example}». اتركه فارغًا لعدم عرض سعر.',
    priceInvalid: 'أدخل مبلغًا مثل 45000',
    saveAndFinish: 'حفظ',
    skipForNow: 'تخطٍّ',
    photosLabel: 'الصور',
    ...
    coverBadge: 'الغلاف',
    addPhotos: 'إضافة صور',
    photoActionsTitle: 'هذه الصورة',
    makeCover: 'اجعلها الغلاف',
    removePhoto: 'إزالة الصورة',
    removePhotoConfirm: 'إزالة هذه الصورة من التصميم؟',
    lastPhotoTitle: 'هذه هي الصورة الوحيدة',
    lastPhotoBody:
      'يحتاج التصميم إلى صورة واحدة على الأقل. احذف التصميم كله بدلًا من ذلك إن لم تعد تريده.',
    maxPhotosTitle: 'هذا أقصى عدد صور لتصميم واحد',
    maxPhotosBody:
      'يتّسع التصميم لـ{max} صور. أزِل واحدة قبل إضافة أخرى.',
