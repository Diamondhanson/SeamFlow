...
export const assistant = {
  ...
  ar: {
    title: 'المساعد',
    subtitle: 'اسأل عن عملك، أو أخبره بما يفعل.',
    ...
    actionCreateOrder: 'طلب جديد',
    actionUpdateOrder: 'تحديث طلب',
    actionSetOrderStatus: 'تغيير حالة الطلب',
    actionAddMeasurements: 'حفظ المقاسات',
    ...
    fieldLabel: 'التسمية',
    fieldCount: 'المقاسات',
    fieldInvoiceNumber: 'الفاتورة',

    toolSearchClients: 'العملاء',
    toolGetClient: 'عميلًا',
    toolSearchOrders: 'الطلبات',
    toolGetOrder: 'طلبًا',
    toolGetClientMeasurements: 'المقاسات',
    toolListInvoices: 'الفواتير',
    toolListFabrics: 'الأقمشة',
    toolListGroupOrders: 'طلبات المجموعات',
    toolGetGroupOrder: 'طلب مجموعة',
    toolBusinessSummary: 'ملخّص عملك',
