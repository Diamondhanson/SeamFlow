export const chome = {
  ...
  ar: {
    ...
    welcome: 'أهلًا بك',
    tagline: 'أناقتك، في مكان واحد.',
    ordersTile: 'طلباتي',
    ordersTileSub: 'تابِع ما يخيطه لك خيّاطوك',
    measurementsTile: 'مقاساتي',
    measurementsTileSub: 'مقاساتك، جاهزة للمشاركة',
    lookbookTile: 'ألبوم الأزياء',
    lookbookTileSub: 'كل قطعة خِيطت لك',
    tailorsTile: 'خيّاطوني',
