...
export const notifications = {
  en: {
    aboutOrder: 'Order',
    aboutConversation: 'Message',
    aboutInvoice: 'Invoice',
    aboutRequest: 'Request',
    aboutOffer: 'Offer',
    aboutSupport: 'Help & Support',
    aboutGeneric: 'Update',
    ...
    // Requests and offers (appendix H), and the two that are pushed rather
    // than stored. Without these the inbox printed the raw key.
    type_request_matched: 'A new request matches what you make: {garmentType}',
    type_offer_received: 'A tailor answered your request for a {garmentType}',
    type_offer_accepted: 'Your offer for a {garmentType} was accepted',
    type_offer_declined: 'Your offer for a {garmentType} was not chosen this time',
    type_support_replied: 'SeamFlow replied to your message',
    type_subscription_expiring: 'Your SeamFlow access ends in {days} days',
  },
  fr: {
    aboutOrder: 'Commande',
    aboutConversation: 'Message',
    aboutInvoice: 'Facture',
    aboutRequest: 'Demande',
    aboutOffer: 'Offre',
    aboutSupport: 'Aide et assistance',
    aboutGeneric: 'Information',
    openOrder: 'Ouvrir la commande',
    openConversation: 'Ouvrir la conversation',
    openInvoice: 'Ouvrir la facture',
    openRequest: 'Ouvrir la demande',
    openOffer: 'Ouvrir l’offre',
    openSupport: 'Ouvrir le ticket',
    title: 'Notifications',
    ...
    type_request_matched: 'Une nouvelle demande correspond à ce que vous faites : {garmentType}',
    type_offer_received: 'Un couturier a répondu à votre demande de {garmentType}',
    type_offer_accepted: 'Votre offre pour un {garmentType} a été acceptée',
    type_offer_declined: 'Votre offre pour un {garmentType} n’a pas été retenue cette fois',
    type_support_replied: 'SeamFlow a répondu à votre message',
    type_subscription_expiring: 'Votre accès SeamFlow se termine dans {days} jours',
  },
  pt: {
    aboutOrder: 'Encomenda',
    aboutConversation: 'Mensagem',
    aboutInvoice: 'Fatura',
    aboutRequest: 'Pedido',
    aboutOffer: 'Proposta',
    aboutSupport: 'Ajuda e apoio',
    aboutGeneric: 'Atualização',
    openOrder: 'Abrir a encomenda',
    openConversation: 'Abrir a conversa',
    openInvoice: 'Abrir a fatura',
    openRequest: 'Abrir o pedido',
    openOffer: 'Abrir a proposta',
    openSupport: 'Abrir o ticket',
    title: 'Notificações',
    empty: 'Ainda nada',
    ...
    type_request_matched: 'Um novo pedido corresponde ao que faz: {garmentType}',
    type_offer_received: 'Um alfaiate respondeu ao seu pedido de {garmentType}',
    type_offer_accepted: 'A sua proposta para {garmentType} foi aceite',
    type_offer_declined: 'A sua proposta para {garmentType} não foi escolhida desta vez',
    type_support_replied: 'A SeamFlow respondeu à sua mensagem',
    type_subscription_expiring: 'O seu acesso à SeamFlow termina em {days} dias',
  },
  es: {
    aboutOrder: 'Pedido',
    aboutConversation: 'Mensaje',
    aboutInvoice: 'Factura',
    aboutRequest: 'Solicitud',
    aboutOffer: 'Oferta',
    aboutSupport: 'Ayuda y soporte',
    aboutGeneric: 'Novedad',
    openOrder: 'Abrir el pedido',
    openConversation: 'Abrir la conversación',
    openInvoice: 'Abrir la factura',
    openRequest: 'Abrir la solicitud',
    openOffer: 'Abrir la oferta',
    openSupport: 'Abrir el ticket',
    ...
    type_request_matched: 'Una nueva solicitud coincide con lo que haces: {garmentType}',
    type_offer_received: 'Un sastre respondió a tu solicitud de {garmentType}',
    type_offer_accepted: 'Tu oferta para {garmentType} fue aceptada',
    type_offer_declined: 'Tu oferta para {garmentType} no fue elegida esta vez',
    type_support_replied: 'SeamFlow respondió a tu mensaje',
    type_subscription_expiring: 'Tu acceso a SeamFlow termina en {days} días',
  },
  sw: {
    aboutOrder: 'Oda',
    aboutConversation: 'Ujumbe',
    aboutInvoice: 'Ankara',
    aboutRequest: 'Ombi',
    aboutOffer: 'Pendekezo',
    aboutSupport: 'Msaada',
    aboutGeneric: 'Taarifa',
    openOrder: 'Fungua oda',
    openConversation: 'Fungua mazungumzo',
    openInvoice: 'Fungua ankara',
    openRequest: 'Fungua ombi',
    openOffer: 'Fungua pendekezo',
    openSupport: 'Fungua tikiti',
    title: 'Arifa',
    ...
    type_request_matched: 'Ombi jipya linalingana na unachoshona: {garmentType}',
    type_offer_received: 'Fundi amejibu ombi lako la {garmentType}',
    type_offer_accepted: 'Pendekezo lako la {garmentType} limekubaliwa',
    type_offer_declined: 'Pendekezo lako la {garmentType} halikuchaguliwa safari hii',
    type_support_replied: 'SeamFlow imejibu ujumbe wako',
    type_subscription_expiring: 'Ufikiaji wako wa SeamFlow unaisha baada ya siku {days}',
  },
  ar: {
    aboutOrder: 'طلب',
    aboutConversation: 'رسالة',
    aboutInvoice: 'فاتورة',
    aboutRequest: 'طلب عميل',
    aboutOffer: 'عرض',
    aboutSupport: 'المساعدة والدعم',
    aboutGeneric: 'تحديث',
    openOrder: 'فتح الطلب',
    ...
    type_request_matched: 'طلب جديد يناسب ما تصنعه: {garmentType}',
    type_offer_received: 'ردّ خياط على طلبك لـ {garmentType}',
    type_offer_accepted: 'تم قبول عرضك لـ {garmentType}',
    type_offer_declined: 'لم يُختَر عرضك لـ {garmentType} هذه المرة',
    type_support_replied: 'ردّت SeamFlow على رسالتك',
    type_subscription_expiring: 'ينتهي وصولك إلى SeamFlow خلال {days} أيام',
  },
};
