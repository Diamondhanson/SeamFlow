...
export const auth = {
  ...
  ar: {
    ...
    openingGoogle: 'يفتح Google…',
    continueWithGoogle: 'المتابعة عبر Google',
    openingApple: 'يفتح Apple…',
    continueWithApple: 'المتابعة عبر Apple',
    orWithEmail: 'أو بالبريد الإلكتروني',
    emailRequired: 'أدخل بريدك الإلكتروني.',
    emailInvalid: 'هذا لا يبدو بريدًا إلكترونيًا.',
    passwordRequired: 'أدخل كلمة المرور.',
    passwordTooShort: 'استخدم {min} حرفًا على الأقل.',
    email: 'البريد الإلكتروني',
    password: 'كلمة المرور',
    passwordWithMin: 'كلمة المرور ({min} أحرف على الأقل)',
    showPassword: 'إظهار كلمة المرور',
    hidePassword: 'إخفاء كلمة المرور',
    sendVerificationCode: 'إرسال رمز التحقق',
    signUpHint: 'سنرسل إليك رمزًا من 6 أرقام بالبريد للتحقق من العنوان.',
    agreePrefix: 'بالمتابعة، فإنك توافق على',
    termsWord: 'الشروط',
    agreeAnd: 'و',
    ...
    finishingSignIn: 'يُكمل تسجيل الدخول…',
    signInCouldNotComplete: 'تعذّر إكمال تسجيل دخولك. حاول مرة أخرى.',
    ...
    sending: 'يُرسل…',
    resendPrompt: 'لم يصلك الرمز؟ أعِد الإرسال',
    useDifferentEmail: '{arrow} استخدم بريدًا آخر',
    verificationFailed: 'فشل التحقق',
    codeSent: 'أُرسل الرمز',
    codeSentMessage: 'تفقّد بريدك لرمز جديد من 6 أرقام.',
    resendFailed: 'فشلت إعادة الإرسال',
    // ----- استعادة كلمة المرور -----
    forgotPassword: 'نسيت كلمة المرور؟',
    resetPasswordTitle: 'إعادة تعيين كلمة المرور',
    resetPasswordIntro:
      'أدخل البريد الذي سجّلت به وسنرسل إليك رمزًا من 6 أرقام.',
    sendResetCode: 'إرسال الرمز',
    sendCodeFailed: 'تعذّر إرسال الرمز',
    resetEnterCodeTitle: 'أدخل الرمز',
    resetEnterCodeIntro: 'أدخل الرمز المكوّن من 6 أرقام واختر كلمة مرور جديدة.',
    newPassword: 'كلمة مرور جديدة',
    newPasswordWithMin: 'كلمة مرور جديدة ({min} أحرف على الأقل)',
    resetPasswordCta: 'إعادة تعيين كلمة المرور',
    resetPasswordFailed: 'تعذّر إعادة تعيين كلمة المرور',
    passwordResetDoneTitle: 'تم تحديث كلمة المرور',
    passwordResetDoneMessage: 'كل شيء جاهز، وقد سجّلت دخولك الآن.',
  },
} as const;
